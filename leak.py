...
df = pd.read_csv('./result/v7/final_ensemble.csv')

test = pd.read_csv('./input/test_no_band.csv')
train = pd.read_csv('./input/train_no_band.csv')
...
df['is_iceberg'] = ans
df[['id','is_iceberg']].to_csv('leaky_best_submission.csv', index=False)
